      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-lg-7 text-center mx-auto">
            <h2 class="section-heading">HIV/AIDS no Brasil</h2>
            <p> Numero estimado do virus no Brasil</p>
          </div>
        </div>
        <div class="row"> 
          <div class="col-lg-4 text-center mx-auto">
            <div class="data">
              <span class="icon text-primary">
                <span class="flaticon-virus">Infectados</span>
              </span>
              <strong class="d-block number">866,000</strong>
          ...
          <div class="col-lg-4 text-center mx-auto">
            <div class="data">
              <span class="icon text-primary">
                <span class="flaticon-virus">Óbtos</span>
              </span>
              <strong class="d-block number">241,500</strong>
              <span class="label">texto</span>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="mb-4 section-heading">O que é HIV/AIDS</h2>
            <p>texto!</p>
    ...
    <div class="container pb-5">
      <div class="row">
        <div class="col-lg-3 text-center mx-auto">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="section-heading mb-4">Qual é a melhor maneira de prevenção?</h2>
            <p>texto</p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 mx-auto text-center">
            <span class="subheading"></span>cuide-se
            <h2 class="mb-4 section-heading">textof</h2>
            <p>texto</p>
          </div>
        </div>
