...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <h1 class="heading mb-3">Area de login </h1>
            <p class="mb-5"> Caso você não tenha um login, clique no botão abaixo.</p>
            <p class="mb-4"><a href="cadastro.html" class="btn btn-primary">Area de cadastro</a></p>
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-lg-7 text-center mx-auto">
            <h2 class="section-heading">Faça seu login</h2>
            <p> Insira seu email cadastrado e sua senha </p>
          </div>
        </div>
        <div class="row"> 
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">ex: emsaude12@gmail.com.</small>
  </div>
  <div class="form-group">
