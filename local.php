...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <h1 class="heading mb-3">Adicionar Intituição </h1>
            <p class="mb-5"> Caso você queira voltar para área do cliente clique abaixo</p>
            <p class="mb-4"><a href="cliente.<?php  ?>" class="btn btn-primary">Area do cliente</a></p>
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-lg-7 text-center mx-auto">
            <h2 class="section-heading">Area de Usuario</h2>
            <p> Veja  as opções </p>
          </div>
        </div>
        
      
   <form method="post" action="addlocal.php">
  <div class="form-row">
  ...
  <div class="form-group">
    ...
    <input type="text"name="complemento" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
  </div>
  <div class="form-row">
