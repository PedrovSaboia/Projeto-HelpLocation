          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="cont.html" class="nav-link">Contato</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <h1 class="heading mb-3">Area de Cadastro </h1>
            <p class="mb-5"> Caso você tenha um login, clique no botão abaixo.</p>
            <p class="mb-4"><a href="login.html" class="btn btn-primary">Area de login</a></p>
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-lg-7 text-center mx-auto">
            <h2 class="section-heading">Cadastramento</h2>
            <p> Insira seu email válido e sua senha </p>
          </div>
        </div>
        <div class="row"> 
 ...
 <form method="post"action="valida_cliente.php">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="name" name="instituicao" class="form-control" id="inputEmail4" placeholder="local onde trabalha">
    </div>
